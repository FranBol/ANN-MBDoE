...
`MBDoE.py` embeds the trained surrogates into a the MBDoE framework. The Fisher Information Matrix is computed using the ANN gradients and the next D-optimal experimental conditions are suggested to maximally improve kinetic parameter estimation.
