...
First principles model for a tubular reactor under unsteady state conditions and an adjoint model with torchdiff. The data set was produced from this model.
...
### `Sequential planning/`
Python script with MBDoE functions is contain here. It contains the evaluation of NN model to compute the sensitivity matrix.
